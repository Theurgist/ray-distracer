...
import cc.theurgist.engine.image.BitmapImage
import cc.theurgist.engine.materials.Material
import cc.theurgist.engine.scene.Scene3D
import cc.theurgist.engine.scene.entities.{Camera, PointLight}
import cc.theurgist.engine.scene.primitives.{Ray, Vec3d}
import cc.theurgist.engine.system.PerformanceTimer

import scala.language.postfixOps

/**
  * Raytracing cc.theurgist.engine
